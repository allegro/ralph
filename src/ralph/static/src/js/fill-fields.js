...
(function($) {
    $(function () {
        ...
        $('.bulk-edit input[type=text]:not(.no-fillable), .bulk-edit select, .bulk-edit textarea, .bulk-edit .autocomplete-widget').blur(function() {
            $('#float_toolbar').hide();
        });
        ...
        $('.bulk-edit input[type=text]:not(.no-fillable), .bulk-edit select, .bulk-edit textarea, .bulk-edit .autocomplete-widget').mouseover(function() {
            toggle_toolbar(this);
        });
