...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Network.gateway_as_int'
        db.add_column('discovery_network', 'gateway_as_int',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Network.gateway_as_int'
        db.delete_column('discovery_network', 'gateway_as_int')
