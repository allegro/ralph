...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IPAddress.scan_summary'
        db.add_column('discovery_ipaddress', 'scan_summary',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scan.ScanSummary'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IPAddress.scan_summary'
        db.delete_column('discovery_ipaddress', 'scan_summary_id')
