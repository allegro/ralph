...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Network.dhcp_broadcast'
        db.add_column('discovery_network', 'dhcp_broadcast',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding M2M table for field custom_dns_servers on 'Network'
        db.create_table('discovery_network_custom_dns_servers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('network', models.ForeignKey(orm['discovery.network'], null=False)),
            ('dnsserver', models.ForeignKey(orm['dnsedit.dnsserver'], null=False))
        ))
        db.create_unique('discovery_network_custom_dns_servers', ['network_id', 'dnsserver_id'])
    ...
    def backwards(self, orm):
        # Deleting field 'Network.dhcp_broadcast'
        db.delete_column('discovery_network', 'dhcp_broadcast')

        # Removing M2M table for field custom_dns_servers on 'Network'
        db.delete_table('discovery_network_custom_dns_servers')
