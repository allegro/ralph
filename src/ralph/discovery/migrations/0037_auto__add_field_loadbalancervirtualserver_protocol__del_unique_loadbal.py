...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LoadBalancerVirtualServer.protocol'
        db.add_column('discovery_loadbalancervirtualserver', 'protocol',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding unique constraint on 'LoadBalancerVirtualServer', fields ['protocol', 'port', 'address']
        db.create_unique('discovery_loadbalancervirtualserver', ['protocol', 'port', 'address_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LoadBalancerVirtualServer', fields ['protocol', 'port', 'address']
        db.delete_unique('discovery_loadbalancervirtualserver', ['protocol', 'port', 'address_id'])

        # Deleting field 'LoadBalancerVirtualServer.protocol'
        db.delete_column('discovery_loadbalancervirtualserver', 'protocol')
    ...
    models = {
        ...
        'discovery.database': {
            ...
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'database_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'databases'", 'to': "orm['discovery.DatabaseType']"}),
        ...
        'discovery.loadbalancervirtualserver': {
            'Meta': {'unique_together': "((u'address', u'port', u'protocol'),)", 'object_name': 'LoadBalancerVirtualServer'},
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.IPAddress']"}),
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'port': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'protocol': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'save_priorities': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['cmdb.CI']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'venture': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['business.Venture']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
