...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('discovery_database', (
            ...
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cmdb.CI'], null=True, on_delete=models.PROTECT)),
            ('device_environment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cmdb.CI'], null=True, on_delete=models.PROTECT)),
            ('parent_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Device'])),
            ('database_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.DatabaseType'])),
        ))
        db.send_create_signal('discovery', ['Database'])

        # Adding model 'DatabaseType'
        db.create_table('discovery_databasetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('discovery', ['DatabaseType'])

        # Adding model 'LoadBalancerType'
        db.create_table('discovery_loadbalancertype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('discovery', ['LoadBalancerType'])

        # Adding field 'LoadBalancerVirtualServer.venture'
        db.add_column('discovery_loadbalancervirtualserver', 'venture',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.Venture'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'LoadBalancerVirtualServer.service'
        db.add_column('discovery_loadbalancervirtualserver', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cmdb.CI'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'LoadBalancerVirtualServer.device_environment'
        db.add_column('discovery_loadbalancervirtualserver', 'device_environment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cmdb.CI'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'LoadBalancerVirtualServer.load_balancer_type'
        db.add_column('discovery_loadbalancervirtualserver', 'load_balancer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['discovery.LoadBalancerType']),
                      keep_default=False)


        # Changing field 'LoadBalancerVirtualServer.default_pool'
        db.alter_column('discovery_loadbalancervirtualserver', 'default_pool_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.LoadBalancerPool'], null=True))
        # Adding unique constraint on 'LoadBalancerVirtualServer', fields ['port', 'address']
        db.create_unique('discovery_loadbalancervirtualserver', ['port', 'address_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LoadBalancerVirtualServer', fields ['port', 'address']
        db.delete_unique('discovery_loadbalancervirtualserver', ['port', 'address_id'])

        # Deleting model 'Database'
        db.delete_table('discovery_database')

        # Deleting model 'DatabaseType'
        db.delete_table('discovery_databasetype')

        # Deleting model 'LoadBalancerType'
        db.delete_table('discovery_loadbalancertype')

        # Deleting field 'LoadBalancerVirtualServer.venture'
        db.delete_column('discovery_loadbalancervirtualserver', 'venture_id')

        # Deleting field 'LoadBalancerVirtualServer.service'
        db.delete_column('discovery_loadbalancervirtualserver', 'service_id')

        # Deleting field 'LoadBalancerVirtualServer.device_environment'
        db.delete_column('discovery_loadbalancervirtualserver', 'device_environment_id')

        # Deleting field 'LoadBalancerVirtualServer.load_balancer_type'
        db.delete_column('discovery_loadbalancervirtualserver', 'load_balancer_type_id')
    ...
    models = {
        ...
        'discovery.database': {
            ...
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'database_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.DatabaseType']"}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent_device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.Device']"}),
            'save_priorities': ('django.db.models.fields.TextField', [], {'default': "u''"}),
        ...
        'discovery.databasetype': {
            'Meta': {'ordering': "(u'name',)", 'object_name': 'DatabaseType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'discovery.loadbalancertype': {
            'Meta': {'ordering': "(u'name',)", 'object_name': 'LoadBalancerType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'discovery.loadbalancervirtualserver': {
            'Meta': {'unique_together': "((u'address', u'port'),)", 'object_name': 'LoadBalancerVirtualServer'},
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.IPAddress']"}),
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'default_pool': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.LoadBalancerPool']", 'null': 'True'}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.Device']"}),
            'device_environment': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['cmdb.CI']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'load_balancer_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.LoadBalancerType']"}),
            'max_save_priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'port': ('django.db.models.fields.PositiveIntegerField', [], {}),
