...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IPAddress.is_buried'
        db.add_column('discovery_ipaddress', 'is_buried',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IPAddress.is_buried'
        db.delete_column('discovery_ipaddress', 'is_buried')
