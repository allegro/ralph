...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoryModelChange'
        db.create_table('discovery_historymodelchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('device_model', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.DeviceModel'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('component_model', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.ComponentModel'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('device_model_group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.DeviceModelGroup'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('component_model_group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.ComponentModelGroup'], null=True, on_delete=models.SET_NULL, blank=True)),
        ...
        db.send_create_signal('discovery', ['HistoryModelChange'])

        # Adding field 'ComponentModelGroup.created'
        db.add_column('discovery_componentmodelgroup', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'ComponentModelGroup.modified'
        db.add_column('discovery_componentmodelgroup', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'ComponentModelGroup.cache_version'
        db.add_column('discovery_componentmodelgroup', 'cache_version',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DeviceModelGroup.created'
        db.add_column('discovery_devicemodelgroup', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DeviceModelGroup.modified'
        db.add_column('discovery_devicemodelgroup', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DeviceModelGroup.cache_version'
        db.add_column('discovery_devicemodelgroup', 'cache_version',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DeprecationKind.default'
        db.add_column('discovery_deprecationkind', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HistoryModelChange'
        db.delete_table('discovery_historymodelchange')

        # Deleting field 'ComponentModelGroup.created'
        db.delete_column('discovery_componentmodelgroup', 'created')

        # Deleting field 'ComponentModelGroup.modified'
        db.delete_column('discovery_componentmodelgroup', 'modified')

        # Deleting field 'ComponentModelGroup.cache_version'
        db.delete_column('discovery_componentmodelgroup', 'cache_version')

        # Deleting field 'DeviceModelGroup.created'
        db.delete_column('discovery_devicemodelgroup', 'created')

        # Deleting field 'DeviceModelGroup.modified'
        db.delete_column('discovery_devicemodelgroup', 'modified')

        # Deleting field 'DeviceModelGroup.cache_version'
        db.delete_column('discovery_devicemodelgroup', 'cache_version')

        # Deleting field 'DeprecationKind.default'
        db.delete_column('discovery_deprecationkind', 'default')
    ...
    models = {
        ...
        'discovery.operatingsystem': {
            'Meta': {'ordering': "(u'label',)", 'object_name': 'OperatingSystem'},
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
