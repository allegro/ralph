...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DataCenter.next_server'
        db.delete_column('discovery_datacenter', 'next_server')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DataCenter.next_server'
        db.add_column('discovery_datacenter', 'next_server',
