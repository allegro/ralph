...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('discovery_environment', (
        ...
        db.send_create_signal('discovery', ['Environment'])

        # Adding field 'Network.environment'
        db.add_column('discovery_network', 'environment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Environment'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Network.data_center'
        db.alter_column('discovery_network', 'data_center_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.DataCenter'], null=True))

    def backwards(self, orm):
        # Deleting model 'Environment'
        db.delete_table('discovery_environment')

        # Deleting field 'Network.environment'
        db.delete_column('discovery_network', 'environment_id')


        # Changing field 'Network.data_center'
        db.alter_column('discovery_network', 'data_center_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['discovery.DataCenter']))
