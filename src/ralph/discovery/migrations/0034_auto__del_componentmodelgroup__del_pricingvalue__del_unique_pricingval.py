...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PricingGroup', fields ['name', 'date']
        db.delete_unique('discovery_pricinggroup', ['name', 'date'])

        # Removing unique constraint on 'PricingVariable', fields ['group', 'name']
        db.delete_unique('discovery_pricingvariable', ['group_id', 'name'])

        # Removing unique constraint on 'PricingValue', fields ['device', 'variable']
        db.delete_unique('discovery_pricingvalue', ['device_id', 'variable_id'])

        # Deleting model 'ComponentModelGroup'
        db.delete_table('discovery_componentmodelgroup')

        # Deleting model 'PricingValue'
        db.delete_table('discovery_pricingvalue')

        # Deleting model 'PricingVariable'
        db.delete_table('discovery_pricingvariable')
        ...
        # Deleting model 'PricingGroup'
        db.delete_table('discovery_pricinggroup')

        # Removing M2M table for field devices on 'PricingGroup'
        db.delete_table('discovery_pricinggroup_devices')

        # Deleting model 'PricingFormula'
        db.delete_table('discovery_pricingformula')
        ...
        # Deleting field 'HistoryModelChange.device_model_group'
        db.delete_column('discovery_historymodelchange', 'device_model_group_id')

        # Deleting field 'HistoryModelChange.component_model_group'
        db.delete_column('discovery_historymodelchange', 'component_model_group_id')

        # Adding field 'Device.service'
        db.add_column('discovery_device', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cmdb.CI'], null=True, on_delete=models.PROTECT),
                      keep_default=False)
        ...
        # Deleting field 'ComponentModel.group'
        db.delete_column('discovery_componentmodel', 'group_id')

        # Deleting field 'DeviceModel.group'
        db.delete_column('discovery_devicemodel', 'group_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('discovery_componentmodelgroup', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=75, unique=True, db_index=True)),
        ...
        # Adding model 'PricingValue'
        db.create_table('discovery_pricingvalue', (
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Device'])),
            ('variable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.PricingVariable'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal('discovery', ['PricingValue'])

        # Adding unique constraint on 'PricingValue', fields ['device', 'variable']
        db.create_unique('discovery_pricingvalue', ['device_id', 'variable_id'])

        # Adding model 'PricingVariable'
        db.create_table('discovery_pricingvariable', (
            ('aggregate', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.PricingGroup'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('discovery', ['PricingVariable'])

        # Adding unique constraint on 'PricingVariable', fields ['group', 'name']
        db.create_unique('discovery_pricingvariable', ['group_id', 'name'])
        ...
        # Adding model 'PricingGroup'
        db.create_table('discovery_pricinggroup', (
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('discovery', ['PricingGroup'])

        # Adding M2M table for field devices on 'PricingGroup'
        db.create_table('discovery_pricinggroup_devices', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pricinggroup', models.ForeignKey(orm['discovery.pricinggroup'], null=False)),
            ('device', models.ForeignKey(orm['discovery.device'], null=False))
        ))
        db.create_unique('discovery_pricinggroup_devices', ['pricinggroup_id', 'device_id'])

        # Adding unique constraint on 'PricingGroup', fields ['name', 'date']
        db.create_unique('discovery_pricinggroup', ['name', 'date'])

        # Adding model 'PricingFormula'
        db.create_table('discovery_pricingformula', (
            ('formula', self.gf('django.db.models.fields.TextField')()),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.PricingGroup'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('component_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.ComponentModelGroup'])),
        ))
        db.send_create_signal('discovery', ['PricingFormula'])
        ...
        # Adding model 'DiscoveryWarning'
        db.create_table('discovery_discoverywarning', (
        ...
        # Adding field 'HistoryModelChange.device_model_group'
        db.add_column('discovery_historymodelchange', 'device_model_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.DeviceModelGroup'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'HistoryModelChange.component_model_group'
        db.add_column('discovery_historymodelchange', 'component_model_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.ComponentModelGroup'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'Device.service'
        db.delete_column('discovery_device', 'service_id')

        # Deleting field 'Device.device_environment'
        db.delete_column('discovery_device', 'device_environment_id')

        # Adding field 'ComponentModel.group'
        db.add_column('discovery_componentmodel', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.ComponentModelGroup'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'DeviceModel.group'
        db.add_column('discovery_devicemodel', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['discovery.DeviceModelGroup'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
