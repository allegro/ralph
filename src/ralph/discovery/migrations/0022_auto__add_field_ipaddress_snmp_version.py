...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IPAddress.snmp_version'
        db.add_column('discovery_ipaddress', 'snmp_version',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IPAddress.snmp_version'
        db.delete_column('discovery_ipaddress', 'snmp_version')
