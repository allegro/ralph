...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.deprecation_date'
        db.add_column('discovery_device', 'deprecation_date',
    ...
    def backwards(self, orm):
        # Deleting field 'Device.deprecation_date'
        db.delete_column('discovery_device', 'deprecation_date')
