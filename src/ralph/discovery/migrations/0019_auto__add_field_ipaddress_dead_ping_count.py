...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IPAddress.dead_ping_count'
        db.add_column('discovery_ipaddress', 'dead_ping_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IPAddress.dead_ping_count'
        db.delete_column('discovery_ipaddress', 'dead_ping_count')
