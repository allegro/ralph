...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Network.reserved_top_margin'
        db.add_column('discovery_network', 'reserved_top_margin',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Network.reserved_top_margin'
        db.delete_column('discovery_network', 'reserved_top_margin')
