...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Network.environment'
        db.alter_column('discovery_network', 'environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Environment'], null=True, on_delete=models.SET_NULL))
        # Adding field 'Environment.remarks'
        db.add_column('discovery_environment', 'remarks',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Network.environment'
        db.alter_column('discovery_network', 'environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.Environment'], null=True))
        # Deleting field 'Environment.remarks'
        db.delete_column('discovery_environment', 'remarks')
