...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('discovery_loadbalancervirtualserver', 'venture',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'loadbalancervirtualservers', on_delete=models.SET_NULL, default=None, to=orm['business.Venture'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'LoadBalancerVirtualServer.service'
        db.add_column('discovery_loadbalancervirtualserver', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'loadbalancervirtualservers', null=True, on_delete=models.PROTECT, to=orm['cmdb.CI']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LoadBalancerVirtualServer.default_pool'
        db.alter_column('discovery_loadbalancervirtualserver', 'default_pool_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['discovery.LoadBalancerPool']))
    ...
    models = {
        ...
        'discovery.loadbalancervirtualserver': {
            ...
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discovery.Device']"}),
            'device_environment': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'loadbalancervirtualservers'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['cmdb.CI']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_save_priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'port': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'save_priorities': ('django.db.models.fields.TextField', [], {'default': "u''"}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'loadbalancervirtualservers'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['cmdb.CI']"}),
            'venture': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'loadbalancervirtualservers'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['business.Venture']", 'blank': 'True', 'null': 'True'})
        },
