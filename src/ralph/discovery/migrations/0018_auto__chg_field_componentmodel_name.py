...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComponentModel.name'
        db.alter_column('discovery_componentmodel', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ComponentModel.name'
        db.alter_column('discovery_componentmodel', 'name', self.gf('django.db.models.fields.CharField')(max_length=75))
