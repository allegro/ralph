...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('discovery_operatingsystem', (
            ...
            ('memory', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('storage', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('cores_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('discovery', ['OperatingSystem'])

        # Adding field 'DeprecationKind.created'
        db.add_column('discovery_deprecationkind', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DeprecationKind.modified'
        db.add_column('discovery_deprecationkind', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DeprecationKind.cache_version'
        db.add_column('discovery_deprecationkind', 'cache_version',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('discovery_operatingsystem')

        # Deleting field 'DeprecationKind.created'
        db.delete_column('discovery_deprecationkind', 'created')

        # Deleting field 'DeprecationKind.modified'
        db.delete_column('discovery_deprecationkind', 'modified')

        # Deleting field 'DeprecationKind.cache_version'
        db.delete_column('discovery_deprecationkind', 'cache_version')
