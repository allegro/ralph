...
import mptt.fields
import ralph.data_center.fields
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='network',
            name='tree_id',
            field=models.PositiveIntegerField(default=None, db_index=True, editable=False),
            preserve_default=False,
        ),
        ...
        migrations.AlterField(
            model_name='network',
            name='address',
            field=ralph.data_center.fields.IPNetwork(verbose_name='network address', help_text='Presented as string (e.g. 192.168.0.0/24)'),
        ),
        migrations.AlterField(
            model_name='network',
            name='max_ip',
