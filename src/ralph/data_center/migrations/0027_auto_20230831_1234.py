...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('data_center', '0026_auto_20170614_1237'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='datacenter',
            name='shortcut',
            field=models.CharField(verbose_name='shortcut', max_length=256, blank=True, null=True),
        ),
        migrations.AddField(
            model_name='datacenter',
            name='type',
            field=models.PositiveIntegerField(verbose_name='data center type', blank=True, null=True, choices=[(1, 'Data Center'), (2, 'Coworking space'), (3, 'Call center'), (4, 'Depot'), (5, 'Warehouse'), (6, 'Retail'), (7, 'Office')]),
        ),
    ]
