...
ACCEPT_ASSETS_FOR_CURRENT_USER_CONFIG = {
    ...
    'BACK_OFFICE_ACCEPT_STATUS': os.environ.get(
        'ACCEPT_ASSETS_FOR_CURRENT_USER_BACK_OFFICE_ACCEPT_STATUS', 11
    ),
    ...
    'BACK_OFFICE_ACCEPT_TEAM_ASSET_STATUS': os.environ.get(
        'ACCEPT_TEAM_ASSETS_FOR_CURRENT_USER_BACK_OFFICE_ACCEPT_STATUS', 103
    ),
    'BACK_OFFICE_ACCEPT_TEST_ASSET_STATUS': os.environ.get(
