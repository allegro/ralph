...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JiraService.business_person'
        db.add_column('cmdb_jiraservice', 'business_person',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'JiraService.business_person_mail'
        db.add_column('cmdb_jiraservice', 'business_person_mail',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JiraService.business_person'
        db.delete_column('cmdb_jiraservice', 'business_person')

        # Deleting field 'JiraService.business_person_mail'
        db.delete_column('cmdb_jiraservice', 'business_person_mail')
