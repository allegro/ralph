...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CIChangeCMDBHistory'
        db.create_table('cmdb_cichangecmdbhistory', (
        ...
        db.send_create_signal('cmdb', ['CIChangeCMDBHistory'])


    def backwards(self, orm):
        # Deleting model 'CIChangeCMDBHistory'
        db.delete_table('cmdb_cichangecmdbhistory')
