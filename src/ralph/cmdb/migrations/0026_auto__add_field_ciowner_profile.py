...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIOwner.profile'
        db.add_column('cmdb_ciowner', 'profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.Profile'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CIOwner.profile'
        db.delete_column('cmdb_ciowner', 'profile_id')
