...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CIProblem.ci'
        db.delete_column('cmdb_ciproblem', 'ci_id')

        # Removing M2M table for field additional_cis on 'CIProblem'
        db.delete_table('cmdb_ciproblem_additional_cis')

        # Deleting field 'JiraChanges.ci'
        db.delete_column('cmdb_jirachanges', 'ci_id')

        # Removing M2M table for field additional_cis on 'JiraChanges'
        db.delete_table('cmdb_jirachanges_additional_cis')

        # Deleting field 'CIIncident.ci'
        db.delete_column('cmdb_ciincident', 'ci_id')

        # Removing M2M table for field additional_cis on 'CIIncident'
        db.delete_table('cmdb_ciincident_additional_cis')


    def backwards(self, orm):
        # Adding field 'CIProblem.ci'
        db.add_column('cmdb_ciproblem', 'ci',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'old_ciproblem', null=True, to=orm['cmdb.CI'], blank=True),
                      keep_default=False)

        # Adding M2M table for field additional_cis on 'CIProblem'
        db.create_table('cmdb_ciproblem_additional_cis', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ciproblem', models.ForeignKey(orm['cmdb.ciproblem'], null=False)),
            ('ci', models.ForeignKey(orm['cmdb.ci'], null=False))
        ))
        db.create_unique('cmdb_ciproblem_additional_cis', ['ciproblem_id', 'ci_id'])

        # Adding field 'JiraChanges.ci'
        db.add_column('cmdb_jirachanges', 'ci',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'old_jirachanges', null=True, to=orm['cmdb.CI'], blank=True),
                      keep_default=False)

        # Adding M2M table for field additional_cis on 'JiraChanges'
        db.create_table('cmdb_jirachanges_additional_cis', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('jirachanges', models.ForeignKey(orm['cmdb.jirachanges'], null=False)),
            ('ci', models.ForeignKey(orm['cmdb.ci'], null=False))
        ))
        db.create_unique('cmdb_jirachanges_additional_cis', ['jirachanges_id', 'ci_id'])

        # Adding field 'CIIncident.ci'
        db.add_column('cmdb_ciincident', 'ci',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'old_ciincident', null=True, to=orm['cmdb.CI'], blank=True),
                      keep_default=False)

        # Adding M2M table for field additional_cis on 'CIIncident'
        db.create_table('cmdb_ciincident_additional_cis', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ciincident', models.ForeignKey(orm['cmdb.ciincident'], null=False)),
            ('ci', models.ForeignKey(orm['cmdb.ci'], null=False))
        ))
        db.create_unique('cmdb_ciincident_additional_cis', ['ciincident_id', 'ci_id'])
