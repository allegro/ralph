...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JiraChanges'
        db.create_table('cmdb_jirachanges', (
            ...
            ('analysis', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('problems', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('issue_type', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ...
            ('resolvet_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('planned_start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('planned_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('cmdb', ['JiraChanges'])

        # Deleting field 'CIProblem.time'
        db.delete_column('cmdb_ciproblem', 'time')

        # Adding field 'CIProblem.priority'
        db.add_column('cmdb_ciproblem', 'priority',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.issue_type'
        db.add_column('cmdb_ciproblem', 'issue_type',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.created_date'
        db.add_column('cmdb_ciproblem', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.update_date'
        db.add_column('cmdb_ciproblem', 'update_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.resolvet_date'
        db.add_column('cmdb_ciproblem', 'resolvet_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.planned_start_date'
        db.add_column('cmdb_ciproblem', 'planned_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.planned_end_date'
        db.add_column('cmdb_ciproblem', 'planned_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CIIncident.time'
        db.delete_column('cmdb_ciincident', 'time')

        # Adding field 'CIIncident.priority'
        db.add_column('cmdb_ciincident', 'priority',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.issue_type'
        db.add_column('cmdb_ciincident', 'issue_type',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.created_date'
        db.add_column('cmdb_ciincident', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.update_date'
        db.add_column('cmdb_ciincident', 'update_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.resolvet_date'
        db.add_column('cmdb_ciincident', 'resolvet_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.planned_start_date'
        db.add_column('cmdb_ciincident', 'planned_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.planned_end_date'
        db.add_column('cmdb_ciincident', 'planned_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'JiraChanges'
        db.delete_table('cmdb_jirachanges')


        # User chose to not deal with backwards NULL issues for 'CIProblem.time'
        raise RuntimeError("Cannot reverse this migration. 'CIProblem.time' and its values cannot be restored.")
        # Deleting field 'CIProblem.priority'
        db.delete_column('cmdb_ciproblem', 'priority')

        # Deleting field 'CIProblem.issue_type'
        db.delete_column('cmdb_ciproblem', 'issue_type')

        # Deleting field 'CIProblem.created_date'
        db.delete_column('cmdb_ciproblem', 'created_date')

        # Deleting field 'CIProblem.update_date'
        db.delete_column('cmdb_ciproblem', 'update_date')

        # Deleting field 'CIProblem.resolvet_date'
        db.delete_column('cmdb_ciproblem', 'resolvet_date')

        # Deleting field 'CIProblem.planned_start_date'
        db.delete_column('cmdb_ciproblem', 'planned_start_date')

        # Deleting field 'CIProblem.planned_end_date'
        db.delete_column('cmdb_ciproblem', 'planned_end_date')


        # User chose to not deal with backwards NULL issues for 'CIIncident.time'
        raise RuntimeError("Cannot reverse this migration. 'CIIncident.time' and its values cannot be restored.")
        # Deleting field 'CIIncident.priority'
        db.delete_column('cmdb_ciincident', 'priority')

        # Deleting field 'CIIncident.issue_type'
        db.delete_column('cmdb_ciincident', 'issue_type')

        # Deleting field 'CIIncident.created_date'
        db.delete_column('cmdb_ciincident', 'created_date')

        # Deleting field 'CIIncident.update_date'
        db.delete_column('cmdb_ciincident', 'update_date')

        # Deleting field 'CIIncident.resolvet_date'
        db.delete_column('cmdb_ciincident', 'resolvet_date')

        # Deleting field 'CIIncident.planned_start_date'
        db.delete_column('cmdb_ciincident', 'planned_start_date')

        # Deleting field 'CIIncident.planned_end_date'
        db.delete_column('cmdb_ciincident', 'planned_end_date')
