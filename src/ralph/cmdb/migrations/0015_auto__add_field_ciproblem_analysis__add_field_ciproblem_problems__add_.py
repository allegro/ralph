...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIProblem.analysis'
        db.add_column('cmdb_ciproblem', 'analysis',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIProblem.problems'
        db.add_column('cmdb_ciproblem', 'problems',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.analysis'
        db.add_column('cmdb_ciincident', 'analysis',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIIncident.problems'
        db.add_column('cmdb_ciincident', 'problems',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CIProblem.analysis'
        db.delete_column('cmdb_ciproblem', 'analysis')

        # Deleting field 'CIProblem.problems'
        db.delete_column('cmdb_ciproblem', 'problems')

        # Deleting field 'CIIncident.analysis'
        db.delete_column('cmdb_ciincident', 'analysis')

        # Deleting field 'CIIncident.problems'
        db.delete_column('cmdb_ciincident', 'problems')
