...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArchivedCIChangeZabbixTrigger.status'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ArchivedCIChangeZabbixTrigger.trigger_id'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'trigger_id', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'ArchivedCIChangeZabbixTrigger.priority'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'priority', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ArchivedCIChangeZabbixTrigger.host_id'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'host_id', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'CIChangeZabbixTrigger.status'
        db.alter_column('cmdb_cichangezabbixtrigger', 'status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CIChangeZabbixTrigger.trigger_id'
        db.alter_column('cmdb_cichangezabbixtrigger', 'trigger_id', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'CIChangeZabbixTrigger.priority'
        db.alter_column('cmdb_cichangezabbixtrigger', 'priority', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CIChangeZabbixTrigger.host_id'
        db.alter_column('cmdb_cichangezabbixtrigger', 'host_id', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'ArchivedCIChangeZabbixTrigger.status'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'status', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'ArchivedCIChangeZabbixTrigger.trigger_id'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'trigger_id', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'ArchivedCIChangeZabbixTrigger.priority'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'priority', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'ArchivedCIChangeZabbixTrigger.host_id'
        db.alter_column('cmdb_archivedcichangezabbixtrigger', 'host_id', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'CIChangeZabbixTrigger.status'
        db.alter_column('cmdb_cichangezabbixtrigger', 'status', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'CIChangeZabbixTrigger.trigger_id'
        db.alter_column('cmdb_cichangezabbixtrigger', 'trigger_id', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'CIChangeZabbixTrigger.priority'
        db.alter_column('cmdb_cichangezabbixtrigger', 'priority', self.gf('django.db.models.fields.IntegerField')(max_length=11))

        # Changing field 'CIChangeZabbixTrigger.host_id'
        db.alter_column('cmdb_cichangezabbixtrigger', 'host_id', self.gf('django.db.models.fields.IntegerField')(max_length=11))
