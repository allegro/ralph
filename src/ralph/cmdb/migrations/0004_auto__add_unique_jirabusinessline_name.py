...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'JiraBusinessLine', fields ['name']
        db.create_unique('cmdb_jirabusinessline', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'JiraBusinessLine', fields ['name']
        db.delete_unique('cmdb_jirabusinessline', ['name'])
