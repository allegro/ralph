...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmdb_jiraservice', (
            ...
            ('jira_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, db_index=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('it_person', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('it_person_mail', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
