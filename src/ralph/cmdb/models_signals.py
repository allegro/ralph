...
@receiver(post_save, sender=Venture, dispatch_uid='ralph.cmdb.createci')
@receiver(post_save, sender=VentureRole, dispatch_uid='ralph.cmdb.createci')
@receiver(post_save, sender=DataCenter, dispatch_uid='ralph.cmdb.createci')
@receiver(post_save, sender=Network, dispatch_uid='ralph.cmdb.createci')
@receiver(post_save, sender=Service, dispatch_uid='ralph.cmdb.createci')
@receiver(post_save, sender=BusinessLine, dispatch_uid='ralph.cmdb.createci')
@receiver(post_save, sender=Device, dispatch_uid='ralph.cmdb.createci')
