...
urlpatterns = patterns(
    ...
    url(r'^ci/edit/(?P<ci_id>\w+)/main/$', login_required(MainCIEdit.as_view()), name='ci_edit_main'),
    url(r'^ci/edit/(?P<ci_id>\w+)/relations/$', login_required(CIRelationsEdit.as_view()), name='ci_edit_relations'),
    url(r'^ci/edit/(?P<ci_id>\w+)/git/$', login_required(CIGitEdit.as_view()), name='ci_edit_git'),
    url(r'^ci/edit/(?P<ci_id>\w+)/puppet/$', login_required(CIPuppetEdit.as_view()), name='ci_edit_puppet'),
    url(r'^ci/edit/(?P<ci_id>\w+)/ralph/$', login_required(CIRalphEdit.as_view()), name='ci_edit_ralph'),
    url(r'^ci/edit/(?P<ci_id>\w+)/ci_changes/$', login_required(CIChangesEdit.as_view()), name='ci_edit_ci_changes'),
    url(r'^ci/edit/(?P<ci_id>\w+)/zabbix/$', login_required(CIZabbixEdit.as_view()), name='ci_edit_zabbix'),
    url(r'^ci/edit/(?P<ci_id>\w+)/problems/$', login_required(CIProblemsEdit.as_view()), name='ci_edit_problems'),
    url(r'^ci/edit/(?P<ci_id>\w+)/incidents/$', login_required(CIIncidentsEdit.as_view()), name='ci_edit_incidents'),
