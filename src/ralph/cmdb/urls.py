...
urlpatterns = patterns(
    ...
    url(r'^ci/view/(?P<ci_id>\w+)$', login_required(MainCIView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)$', login_required(MainCIView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/main/$', login_required(MainCIView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/main/$', login_required(MainCIView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/relations/$', login_required(CIRelationsView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/relations/$', login_required(CIRelationsView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/git/$', login_required(CIGitView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/git/$', login_required(CIGitView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/puppet/$', login_required(CIPuppetView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/puppet/$', login_required(CIPuppetView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/ralph/$', login_required(CIRalphView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/ralph/$', login_required(CIRalphView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/ci_changes/$', login_required(CIChangesView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/ci_changes/$', login_required(CIChangesView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/zabbix/$', login_required(CIZabbixView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/zabbix/$', login_required(CIZabbixView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/problems/$', login_required(CIProblemsView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/problems/$', login_required(CIProblemsView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/incidents/$', login_required(CIIncidentsView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/incidents/$', login_required(CIIncidentsView.as_view())),
    url(r'^ci/view/(?P<ci_id>\w+)/so/$', login_required(CISOEventsView.as_view()), name='ci_view'),
    (r'^ci/view/(?P<ci_id>[a-z]{2}-[0-9]+)/so/$', login_required(CISOEventsView.as_view())),
