...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DHCPServer.dhcp_config'
        db.add_column('dnsedit_dhcpserver', 'dhcp_config',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DHCPServer.dhcp_config'
        db.delete_column('dnsedit_dhcpserver', 'dhcp_config')
