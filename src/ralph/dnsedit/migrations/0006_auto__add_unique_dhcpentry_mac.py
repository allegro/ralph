...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DHCPEntry', fields ['mac']
        db.create_unique('dnsedit_dhcpentry', ['mac'])


    def backwards(self, orm):
        # Removing unique constraint on 'DHCPEntry', fields ['mac']
        db.delete_unique('dnsedit_dhcpentry', ['mac'])
