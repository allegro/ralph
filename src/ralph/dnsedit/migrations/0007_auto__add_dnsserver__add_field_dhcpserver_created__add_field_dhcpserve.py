...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dnsedit_dnsserver', (
            ...
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        ...
        # Adding field 'DHCPServer.modified'
        db.add_column('dnsedit_dhcpserver', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DHCPServer.cache_version'
        db.add_column('dnsedit_dhcpserver', 'cache_version',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DHCPServer.modified'
        db.delete_column('dnsedit_dhcpserver', 'modified')

        # Deleting field 'DHCPServer.cache_version'
        db.delete_column('dnsedit_dhcpserver', 'cache_version')
    ...
    models = {
        ...
        'dnsedit.dhcpentry': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'number': ('django.db.models.fields.BigIntegerField', [], {'default': '0'})
        },
        'dnsedit.dhcpserver': {
