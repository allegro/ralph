    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.CharField(blank=True, max_length=64, verbose_name='company')),
                ('employee_id', models.CharField(blank=True, max_length=64, verbose_name='employee id')),
                ('profit_center', models.CharField(blank=True, max_length=1024, verbose_name='profit center')),
                ('cost_center', models.CharField(blank=True, max_length=1024, verbose_name='cost center')),
                ('department', models.CharField(blank=True, max_length=64, verbose_name='department')),
                ('manager', models.CharField(blank=True, max_length=1024, verbose_name='manager')),
                ('location', models.CharField(blank=True, max_length=128, verbose_name='location')),
                ('segment', models.CharField(blank=True, max_length=256, verbose_name='segment')),
