    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', verbose_name='groups', blank=True, to='auth.Group', related_query_name='user', related_name='user_set')),
            ],
            options={
                'verbose_name': 'user',
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='regions',
            field=models.ManyToManyField(blank=True, to='accounts.Region', related_name='users'),
        ),
        migrations.AddField(
            model_name='ralphuser',
            name='team',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='Specific permissions for this user.', verbose_name='user permissions', blank=True, to='auth.Permission', related_query_name='user', related_name='user_set'),
        ),
    ]
