...
ACCEPTANCE_BACK_OFFICE_ACCEPT_LOAN_STATUS = settings.ACCEPT_ASSETS_FOR_CURRENT_USER_CONFIG[
    "BACK_OFFICE_ACCEPT_LOAN_STATUS"
]  # noqa
...
ACCEPTANCE_BACK_OFFICE_TEAM_ACCEPT_STATUS = settings.ACCEPT_ASSETS_FOR_CURRENT_USER_CONFIG[
    "BACK_OFFICE_TEAM_ACCEPT_STATUS"
]  # noqa
ACCEPTANCE_TEAM_ACCEPT_TRANSITION_ID = settings.ACCEPT_ASSETS_FOR_CURRENT_USER_CONFIG[
    "TRANSITION_TEAM_ACCEPT_ID"
]  # noqa
ACCEPTANCE_BACK_OFFICE_TEST_ACCEPT_STATUS = settings.ACCEPT_ASSETS_FOR_CURRENT_USER_CONFIG[
    "BACK_OFFICE_TEST_ACCEPT_STATUS"
]  # noqa
...
get_assets_to_accept_loan = partial(get_assets, status=ACCEPTANCE_BACK_OFFICE_ACCEPT_LOAN_STATUS)
get_assets_to_accept_return = partial(get_assets, status=ACCEPTANCE_BACK_OFFICE_RETURN_STATUS)
get_access_cards_to_accept = partial(get_access_cards, status=ACCEPTANCE_ACCESS_CARD_ACCEPT_STATUS)
get_team_assets_to_accept = partial(get_assets, status=ACCEPTANCE_BACK_OFFICE_TEAM_ACCEPT_STATUS)
get_test_assets_to_accept = partial(get_assets, status=ACCEPTANCE_BACK_OFFICE_TEST_ACCEPT_STATUS)
