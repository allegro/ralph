...
REQUESTS_METRICS_ENABLED = getattr(settings, "ENABLE_REQUESTS_AND_QUERIES_METRICS", True)
LARGE_NUMBER_OF_QUERIES_THRESHOLD = getattr(settings, "LARGE_NUMBER_OF_QUERIES_THRESHOLD", 25)
