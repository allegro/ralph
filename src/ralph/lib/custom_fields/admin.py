...
class CustomFieldValueAdminMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inlines = list(self.inlines) + [self._get_custom_field_value_inline()]
        ...
        * object_url - absolute url to object from which CFV is inherited, if
        ...
        for cfv in obj.custom_fields.select_related("custom_field").order_by(
            ...
            if cfv.content_type_id == obj_content_type_id and cfv.object_id == obj.pk:
                ...
                object = "{}: {}".format(
                    cfv.content_type.model_class()._meta.verbose_name, cfv.object
                )
    ...
    def changeform_view(self, request, object_id=None, form_url="", extra_context=None):
        ...
        if self.show_custom_fields_values_summary and object_id:
            ...
            if obj:
                extra_context["custom_fields_all"] = self._get_custom_fields_values(obj)
