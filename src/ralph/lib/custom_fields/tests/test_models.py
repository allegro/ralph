...
class CustomFieldModelsTestCase(TestCase):
    ...
    def test_update_custom_field_should_add_value(self):
        ...
        self.assertEqual({field_name: field_value}, self.sm1.custom_fields_as_dict)
    ...
    def test_update_custom_field_should_update_value(self):
        ...
        self.assertEqual({field_name: new_value}, self.sm1.custom_fields_as_dict)
...
class CustomFieldInheritanceModelsTestCase(TestCase):
    ...
    def test_admin_get_custom_fields_values_result(self):
        custom_fields_values = SomeModelAdmin._get_custom_fields_values(self.sm1)
        self.assertEqual(
    ...
    def test_cleaning_children_custom_field_values_with_overwrite_from_ancestor(self):
        cfv4 = CustomFieldValue.objects.create(
            object=self.sm1,
            custom_field=self.custom_field_str2,
            value="12345",
