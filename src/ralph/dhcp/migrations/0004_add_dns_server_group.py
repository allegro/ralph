    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dns_server', models.ForeignKey(to='dhcp.DNSServer', on_delete=django.db.models.deletion.CASCADE)),
                ('dns_server_group', models.ForeignKey(to='dhcp.DNSServerGroup', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
                'ordering': ('order',),
            },
