...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.profit_center'
        db.add_column('account_profile', 'profit_center',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'Profile.cost_center'
        db.add_column('account_profile', 'cost_center',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'Profile.department'
        db.add_column('account_profile', 'department',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.profit_center'
        db.delete_column('account_profile', 'profit_center')

        # Deleting field 'Profile.cost_center'
        db.delete_column('account_profile', 'cost_center')

        # Deleting field 'Profile.department'
        db.delete_column('account_profile', 'department')
