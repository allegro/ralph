...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.manager'
        db.alter_column('account_profile', 'manager', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Profile.manager'
        db.alter_column('account_profile', 'manager', self.gf('django.db.models.fields.CharField')(max_length=64))
