...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrebootFile.description'
        db.add_column('deployment_prebootfile', 'description',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'Preboot.description'
        db.add_column('deployment_preboot', 'description',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrebootFile.description'
        db.delete_column('deployment_prebootfile', 'description')

        # Deleting field 'Preboot.description'
        db.delete_column('deployment_preboot', 'description')
