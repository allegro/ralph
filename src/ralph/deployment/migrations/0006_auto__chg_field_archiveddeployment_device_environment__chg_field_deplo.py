...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArchivedDeployment.device_environment'
        db.alter_column('deployment_archiveddeployment', 'device_environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmdb.CI'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Deployment.device_environment'
        db.alter_column('deployment_deployment', 'device_environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmdb.CI'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'ArchivedDeployment.device_environment'
        db.alter_column('deployment_archiveddeployment', 'device_environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.DeviceEnvironment'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Deployment.device_environment'
        db.alter_column('deployment_deployment', 'device_environment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discovery.DeviceEnvironment'], null=True, on_delete=models.SET_NULL))
