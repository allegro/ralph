...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assets_assetcategory', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name=u'children', null=True, to=orm['assets.AssetCategory'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('assets', ['AssetCategory'])

        # Adding field 'Asset.category'
        db.add_column('assets_asset', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.AssetCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AssetCategory'
        db.delete_table('assets_assetcategory')

        # Deleting field 'Asset.category'
        db.delete_column('assets_asset', 'category_id')
    ...
    models = {
        ...
        'assets.asset': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['assets.AssetCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        'assets.assetcategory': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "u'children'", 'null': 'True', 'to': "orm['assets.AssetCategory']"}),
