...
class AssetSearch(AssetsMixin, DataTableMixin):
    ...
    columns = [
        ...
        _('Order no.', field='order_no', sort_expression='order_no',
          bob_tag=True, export=True),
        _('Request date', field='request_date', type='date',
            sort_expression='request_date', bob_tag=True, export=True),
        _('Delivery date', field='delivery_date', type='date',
            sort_expression='delivery_date', bob_tag=True, export=True),
        _('Invoice date', field='invoice_date', type='date',
            sort_expression='invoice_date', bob_tag=True, export=True),
        _('Use date', field='use_date', type='date',
          sort_expression='use_date', bob_tag=True, export=True),
