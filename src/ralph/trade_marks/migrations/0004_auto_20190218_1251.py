...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='trade_marks.TradeMarkRegisteringInstitution', verbose_name='Registering Institution', null=True),
        ),
