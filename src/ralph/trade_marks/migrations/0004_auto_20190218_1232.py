...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TradeMarksAdditionalCountry',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, verbose_name='ID', serialize=False)),
        ...
        migrations.AddField(
            model_name='trademarksadditionalcountry',
            name='trade_mark',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(verbose_name='Registering Institution', to='trade_marks.TradeMarkRegisteringInstitution', null=True),
        ),
