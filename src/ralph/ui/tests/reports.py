...
#        d_kind = DeprecationKind(name='48', months=48)
#        d_kind.save()
#        self.d_kind = d_kind
        # Cross - devices
...
#            deprecation_kind=self.d_kind,
            support_expiration_date='2000-01-02',
            purchase_date='2000-01-03',
            venture=self.venture,
            role=self.venture_role,
            model_name='xxx',
...
#            deprecation_kind=None,
    ...
    def test_models(self):
        ...
        self.assertEqual(unicode(db.deprecation_date), '2000-01-01 00:00:00')
...
#        self.assertNotEqual(db.deprecation_kind, None)
        ...
        self.assertNotEqual(db.role, None)
...
#        self.assertEqual(db.deprecation_kind, None)
    ...
    def test_after_deprecation(self):
        ...
        self.assertEqual(form[0][1], datetime.datetime(2000, 1, 1, 0, 0))
...
#        self.assertEqual(form[0][1], None)
    ...
    def test_no_venture(self):
        ...
        self.assertEqual(form[0][1], None)
        self.assertEqual(len(form), 1)
        self.assertNotEqual(form[0][1], self.venture.name)
