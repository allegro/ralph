...
urlpatterns = patterns('',
                       ...
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>info)/$',
                           login_required(NetworksInfo.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>components)/(?P<device>\d+)$',
                           login_required(NetworksComponents.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>software)/(?P<device>\d+)$',
                           login_required(NetworksSoftware.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>addresses)/$',
                           login_required(NetworksAddresses.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>prices)/(?P<device>\d+)$',
                           login_required(NetworksPrices.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>costs)/(?P<device>\d+)$',
                           login_required(NetworksCosts.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>history)/(?P<device>\d+)$',
                           login_required(NetworksHistory.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>asset)/(?P<device>\d+)$',
                           login_required(NetworksAsset.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>reports)/(?P<report>([a-z][\w_-]*)?)$',
                           login_required(ReportNetworksDeviceList.as_view()), {'device': ''}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>reports)/(?P<device>\d+)$',
                           login_required(NetworksReports.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>autoscan)/$',
                           login_required(NetworksAutoscan.as_view()), {'status': 'new'}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>autoscan)/(?P<status>new|changed|dead|buried|all)/$',
                           login_required(NetworksAutoscan.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>scan)/(?P<address>[\d.]*)/$',
                           login_required(NetworksScan.as_view()), {}, 'networks'),
                       url(r'^networks/(?P<network>[^/]*|(?:[0-9]{1,3}\.){3}[0-9]{1,3}\/[0-9]{1,3})/(?P<details>\w+)/(?P<device>)$',
                           login_required(NetworksDeviceList.as_view()), {}, 'networks'),
