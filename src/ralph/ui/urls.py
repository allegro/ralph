...
from ralph.ui.views.racks import (
        ...
        RacksAddDevice, RacksReports, ReportRacksDeviceList,
        )
...
urlpatterns = patterns('',
    ...
    url(r'^search/(?P<details>reports)/(?P<report>[\w_-]*)$',
    ...
    url(r'^ventures/(?P<venture>)(?P<details>info|components|addresses|prices|costs|history|purchase|discover|cmdb)/(?P<device>)$',
        login_required(VenturesDeviceList.as_view()), {}, 'ventures'),
    url(r'^ventures/(?P<venture>[.\w*-]*)/(?P<details>reports)/(?P<report>[\w_-]*)$',
        login_required(ReportVenturesDeviceList.as_view()), {'device': ''}, 'ventures'),
    url(r'^ventures/(?P<venture>)(?P<details>reports)/(?P<report>[\w_-]*)$',
        login_required(ReportVenturesDeviceList.as_view()), {'device': ''}, 'ventures'),
    ...
    url(r'^racks/(?P<rack>[-\w]*)/(?P<details>reports)/(?P<report>[\w_-]*)$',
    ...
    url(r'^networks/(?P<network>[^/]*)/(?P<details>reports)/(?P<report>[\w_-]*)$',
