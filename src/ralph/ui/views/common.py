...
class DataTableColumn(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.foreign_field_name = kwargs.get('foreign_field_name', None)
        self.choice = kwargs.get('choice', False)
...
class PaginationMixin(object):
    ...
    3. Define columns attribute contains list of DataTableColumn objects
    4. In get() function call self.paginate_query(your_query, columns).
