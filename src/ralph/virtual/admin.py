...
class CloudHostTabularInline(RalphTabularInline):
    ...
    get_hypervisor.short_description = 'Hypervisor'
    get_hypervisor.allow_tags = True

    def get_ipaddresses(self, obj):
        return '\n'.join(obj.ip_addresses)
    get_ipaddresses.short_description = 'IP Addresses'
...
class CloudHostAdmin(RalphAdmin):
    ...
    get_ip_addresses.short_description = 'IP Addresses'
...
class CloudProjectAdmin(RalphAdmin):
    fields = ['name', 'project_id', 'cloudprovider', 'service_env', 'tags',
              'remarks']
    list_display = ['name', 'get_service_env', 'get_cloudprovider']
    ...
    def get_service_env(self, obj):
        return obj.service_env
    get_service_env.short_description = 'Service Environment'
