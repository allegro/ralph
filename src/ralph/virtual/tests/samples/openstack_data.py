...
OPENSTACK_DATA = {
    ...
    'project_id_1': {'name': 'modified1', 'tag': 'tag1', 'servers': {
            'host_id_1': {
                'hostname': 'host_id_1',
                'flavor_id': 'flavor_os_id1',
                'tag': 'tag1',
...
OPENSTACK_FLAVOR = {
    'flavor_os_id1': {'name': 'm1-c2-d6', 'cores': 2, 'ram': 1024, 'disk': 6},
    'flavor_os_id2': {
        'name': 'm2-c8-d20', 'cores': 8, 'ram': 2048, 'disk': 20
    },
    'flavor_id_1': {'name': 'change_1', 'cores': 4, 'ram': 4096, 'disk': 12}
}
