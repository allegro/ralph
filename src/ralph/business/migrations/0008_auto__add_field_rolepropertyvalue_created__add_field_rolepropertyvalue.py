...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RolePropertyValue.created'
        db.add_column('business_rolepropertyvalue', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'RolePropertyValue.modified'
        db.add_column('business_rolepropertyvalue', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'RolePropertyValue.cache_version'
        db.add_column('business_rolepropertyvalue', 'cache_version',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RolePropertyValue.created'
        db.delete_column('business_rolepropertyvalue', 'created')

        # Deleting field 'RolePropertyValue.modified'
        db.delete_column('business_rolepropertyvalue', 'modified')

        # Deleting field 'RolePropertyValue.cache_version'
        db.delete_column('business_rolepropertyvalue', 'cache_version')
