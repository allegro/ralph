...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('business_profitcenter', (
        ...
        db.send_create_signal('business', ['ProfitCenter'])
        ...
        db.add_column('business_venture', 'profit_center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.ProfitCenter'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('business_profitcenter')
        ...
        db.delete_column('business_venture', 'profit_center_id')
