...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VentureExtraCost.name'
        db.delete_column('business_ventureextracost', 'name')


    def backwards(self, orm):
        # Adding field 'VentureExtraCost.name'
        db.add_column('business_ventureextracost', 'name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=75, null=True, blank=True),
                      keep_default=False)
