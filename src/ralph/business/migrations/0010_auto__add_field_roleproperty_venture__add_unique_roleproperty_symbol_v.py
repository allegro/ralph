...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoleProperty.venture'
        db.add_column('business_roleproperty', 'venture',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.Venture'], null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'RoleProperty', fields ['symbol', 'venture']
        db.create_unique('business_roleproperty', ['symbol', 'venture_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RoleProperty', fields ['symbol', 'venture']
        db.delete_unique('business_roleproperty', ['symbol', 'venture_id'])

        # Deleting field 'RoleProperty.venture'
        db.delete_column('business_roleproperty', 'venture_id')
    ...
    models = {
        ...
        'business.roleproperty': {
            ...
            'default': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
