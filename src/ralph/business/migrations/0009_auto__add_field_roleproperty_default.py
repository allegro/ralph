...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoleProperty.default'
        db.add_column('business_roleproperty', 'default',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoleProperty.default'
        db.delete_column('business_roleproperty', 'default')
