...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venture.preboot'
        db.add_column('business_venture', 'preboot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['deployment.Preboot'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
        ...
        # Adding field 'VentureRole.preboot'
        db.add_column('business_venturerole', 'preboot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['deployment.Preboot'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Venture.preboot'
        db.delete_column('business_venture', 'preboot_id')

        # Removing M2M table for field networks on 'Venture'
        db.delete_table('business_venture_networks')

        # Deleting field 'VentureRole.preboot'
        db.delete_column('business_venturerole', 'preboot_id')
