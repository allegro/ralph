...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PricingCenter'
        db.create_table('business_pricingcenter', (
        ...
        db.send_create_signal('business', ['PricingCenter'])

        # Adding model 'BusinessSegment'
        db.create_table('business_businesssegment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=75, db_index=True)),
        ))
        db.send_create_signal('business', ['BusinessSegment'])

        # Adding field 'Venture.business_segment'
        db.add_column('business_venture', 'business_segment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.BusinessSegment'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Venture.pricing_center'
        db.add_column('business_venture', 'pricing_center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['business.PricingCenter'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PricingCenter'
        db.delete_table('business_pricingcenter')

        # Deleting model 'BusinessSegment'
        db.delete_table('business_businesssegment')

        # Deleting field 'Venture.business_segment'
        db.delete_column('business_venture', 'business_segment_id')

        # Deleting field 'Venture.pricing_center'
        db.delete_column('business_venture', 'pricing_center_id')
    ...
    models = {
        ...
        'business.pricingcenter': {
            'Meta': {'object_name': 'PricingCenter'},
        ...
        'business.venture': {
            ...
            'pricing_center': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['business.PricingCenter']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
