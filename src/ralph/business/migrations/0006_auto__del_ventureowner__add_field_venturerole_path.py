...
class Migration(SchemaMigration):
    ...
    depends_on = (
            ("cmdb", "0007_auto__add_ciowner__add_ciownership.py"),
    )
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VentureRole.path'
        db.add_column('business_venturerole', 'path',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VentureRole.path'
        db.delete_column('business_venturerole', 'path')
